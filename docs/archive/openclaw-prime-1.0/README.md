...
Live briefing stays at [`docs/openclaw-prime-1.0-briefing.md`](../../openclaw-prime-1.0-briefing.md). These files are historical authority with rewritten freeze-packet citations; they are not production-deploy evidence.
