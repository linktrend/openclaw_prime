...
## LiNKbot-core (LiNKtrend fork)

This fork adds **governed worker runtime hooks** for the LiNKtrend stack (`bot-runtime` integration): bootstrap gating, mission and instruction injection, approved tool allow-lists, and structured lifecycle events. Central governance stays in the monorepo; see [docs/linktrend-governance.md](docs/linktrend-governance.md).
