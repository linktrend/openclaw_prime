...
for wf in linkdev-dispatch.yml linkdev-guard.yml branch-source-policy.yml linkdev-planner-bootstrap.yml linkdev-orchestrator-bootstrap.yml linkdev-agent-watch.yml linkdev-cursor-status.yml; do
