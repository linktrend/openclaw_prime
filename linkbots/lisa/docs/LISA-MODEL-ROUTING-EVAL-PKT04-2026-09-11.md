...
| 2026-07-30 Lisa eval is labeled **superseded for defaults**. It records MiniMax catalog facts (still true above) plus unresolved live-catalog items. It does **not** contain scored Low/Medium/High or Sol comparisons. Its GLM-primary recommendation is **not** reusable as PKT-04 non-coding fallback policy. | `linkbots/lisa/docs/LISA-MODEL-ROUTING-EVAL-2026-07-30.md`; contract doc pointer “superseded for defaults” |
